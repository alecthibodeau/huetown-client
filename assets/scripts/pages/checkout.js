...
let checkoutPage = `
  <div class="checkout-page">
    ...
    The checkout process is separate for downloads and printed items.
    Depending on what you've ordered, choose either of these two options for viewing your cart or completing your purchase.
    <div>
      ...
      <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
        ...
        <input class="paypal-link" type="submit" value="PayPal" alt="PayPal">
      </form>
      for printed items which require shipping (lunar calendars, prints, postcards)
    </div>
