  ...
  <nav id="nav">
    ...
    <div class="nav-menu-icons">
      ...
      <a class="icon" data-title="Instagram" href="https://www.instagram.com/huetown" target="_blank">
        <img src="public/images/icons/icon_instagram_sixty-five_percent_gray.svg" alt="Huetown at Instagram">
      </a>
      </section>
      <section>
        <a class="icon" data-title="Twitter" href="https://www.twitter.com/huetown" target="_blank">
          <img src="public/images/icons/icon_twitter_sixty-five_percent_gray.svg" alt="Huetown at Twitter">
        </a>
      </section>
      <section>
        <a class="icon" data-title="Email" href="mailto:info@huetown.com" target="_blank">
          <img src="public/images/icons/icon_email_sixty-five_percent_gray.svg" alt="Email Huetown">
        </a>
      </section>
    </div>
  </nav>
